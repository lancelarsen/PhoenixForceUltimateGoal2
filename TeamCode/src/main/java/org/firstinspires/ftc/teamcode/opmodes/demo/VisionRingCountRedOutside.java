...
@Disabled
@TeleOp(name = "Ring Count: Red Outside", group = "Vision")
public class VisionRingCountRedOutside extends LinearOpMode {
    @Override
    public void runOpMode() {
        RingVision ringVision = new RingVision(hardwareMap);

        ringVision.init(AutoUtils.Alliance.RED, AutoUtils.StartingPosition.OUTSIDE);
