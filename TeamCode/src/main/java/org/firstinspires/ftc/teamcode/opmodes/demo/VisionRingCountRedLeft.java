...
@TeleOp(name = "Ring Count: Red Left", group = "Vision")
public class VisionRingCountRedLeft extends LinearOpMode {
    @Override
    public void runOpMode() {
        RingVision ringVision = new RingVision(hardwareMap);

        ringVision.init(AutoUtils.StartingPosition.RED_LEFT);
