...
@TeleOp(name = "Vision High Red Target", group = "Test")
public class VisionHighTarget extends LinearOpMode
{
    OpenCvCamera webcam;
    ...
    class SamplePipeline extends OpenCvPipeline
    {
        ...
        /* Threshold Levels  */
        /*----------------------------------------------------------------------*/
        int ON_TARGET_THRESHOLD = 131;

        /*----------------------------------------------------------------------*/
        /* Dimensions of square being scanned  */
        /*----------------------------------------------------------------------*/
        Point region1_pointA = new Point(168,52);
        Point region1_pointB = new Point(157,60);

//        Point region1_pointA = new Point(160,50);
//        Point region1_pointB = new Point(170,60);
        ...
        private volatile OnTarget position = OnTarget.OFF;
        ...
        public Mat processFrame(Mat input)
        {
            ...
            /*----------------------------------------------------------------------*/
            position = OnTarget.OFF;
            if (averageColorLevel > ON_TARGET_THRESHOLD) { position = OnTarget.OFF; }
            else { position = OnTarget.ON; }
            ...
            if (pipeline.position == OnTarget.ON)
            {
                displayColor = GREEN;
            }
            Imgproc.putText(input, String.valueOf(pipeline.position) + " TARGET", new Point(75, 190), 1, 2, displayColor, 2);
